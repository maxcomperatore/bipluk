...
SMTP_FROM_AUTH = getenv("SMTP_FROM_AUTH", "Bipluk <auth@bipluk.com>")
...
SMTP_FROM_MARKETING = getenv("SMTP_FROM_MARKETING", "Bipluk Team <team@news.bipluk.com>")
SMTP_FROM_NEWSLETTER = getenv("SMTP_FROM_NEWSLETTER", "Bipluk Dispatch <team@news.bipluk.com>")
